...
function displayTheaters(theaters) {
    const tbody = document.querySelector('.cinema_table tbody');
    tbody.innerHTML = ''; // Xóa dữ liệu mẫu cũ
...
document.addEventListener('DOMContentLoaded', loadTheaters);
